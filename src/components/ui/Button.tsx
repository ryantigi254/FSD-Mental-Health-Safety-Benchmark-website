...
const variantStyles = {
  primary:
    "bg-fsd-teal text-white hover:bg-fsd-teal/90 shadow-sm hover:shadow-glow-teal",
  secondary:
    "border-2 border-fsd-teal text-fsd-teal hover:bg-fsd-teal/5 hover:shadow-glow-teal-sm",
  ghost:
